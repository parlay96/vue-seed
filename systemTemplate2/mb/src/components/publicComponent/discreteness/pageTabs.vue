<template>
  <div class="pageTabs overflowHidden">
...
<style lang="less">
  .pageTabs {height: calc(100% - 60px);background-color: @pageTabsbgColor;padding: 0;box-sizing: border-box;padding-left: 12px;
    .btnArea {width: 40px;height: 40px;line-height: 40px;text-align: center;overflow: hidden;
      .menuBtn {
        width: 100%;
