<template>
  <el-container class="avue-contail">
    ...
    <el-container>
      <el-header class="avue-haeder" style="height: 100px;">
        <div class="headerPl width100 boxSizing">
          <hae-der/>
...
<script>
  ...
  @Component({
    components: { haeDer, pageTabs, plMenu, customMenu }
  })
...
<style lang="less">
  .avue-contail {
    ...
    // 顶部
    .avue-haeder {width: 100%;z-index: 1024;padding: 0;padding-left: 3px;
      .headerPl {height: 100%;
